...
preload ()
{
    this.load.image('zoey_health', 'Survival_Shooter/assets/sprites/user_interface/health/spr_player_zoey_health.png');
    this.load.image('tom_health', 'Survival_Shooter/assets/sprites/user_interface/health/spr_player_tom_health.png');
    this.load.image('harry_health', 'Survival_Shooter/assets/sprites/user_interface/health/spr_player_harry_health.png');
    this.load.image('health', 'Survival_Shooter/assets/sprites/user_interface/health/spr_player_health_bar.png');
    this.load.image('health_mask', 'Survival_Shooter/assets/sprites/user_interface/health/spr_health_mask.png');
    this.load.image('pauseScreen', 'Survival_Shooter/assets/sprites/user_interface/spr_pause_screen.png');
    this.load.spritesheet('pauseButtons', 'Survival_Shooter/assets/sprites/user_interface/spr_pause_buttons.png',{frameWidth: 649, frameHeight: 119});
}
    create ()
    {
        this.doOnce = true;
