class SP_1_Intro extends Phaser.Scene {
  ...
  preload()
  {
    this.load.audio('voice1', ['Survival_Shooter/assets/sounds/voices/intro/1.wav']);
    this.load.audio('voice2', ['Survival_Shooter/assets/sounds/voices/intro/2.wav']);
    this.load.audio('voice3', ['Survival_Shooter/assets/sounds/voices/intro/3.wav']);
    this.load.audio('voice4', ['Survival_Shooter/assets/sounds/voices/intro/4.wav']);
    this.load.audio('voice5', ['Survival_Shooter/assets/sounds/voices/intro/5.wav']);
    this.load.audio('voice6', ['Survival_Shooter/assets/sounds/voices/intro/6.wav']);
    this.load.audio('voice7', ['Survival_Shooter/assets/sounds/voices/intro/7.wav']);
    this.load.audio('voice8', ['Survival_Shooter/assets/sounds/voices/intro/8.wav']);
    this.load.audio('voice9', ['Survival_Shooter/assets/sounds/voices/intro/9.wav']);
    this.load.audio('voice10', ['Survival_Shooter/assets/sounds/voices/intro/10.wav']);
    this.load.audio('voice11', ['Survival_Shooter/assets/sounds/voices/intro/11.wav']);
    this.load.audio('voice12', ['Survival_Shooter/assets/sounds/voices/intro/12.wav']);
    this.load.audio('voice13', ['Survival_Shooter/assets/sounds/voices/intro/13.wav']);
    this.load.audio('voice14', ['Survival_Shooter/assets/sounds/voices/intro/14.wav']);
    this.load.audio('voice15', ['Survival_Shooter/assets/sounds/voices/intro/15.wav']);
    this.load.audio('voice16', ['Survival_Shooter/assets/sounds/voices/intro/16.wav']);
