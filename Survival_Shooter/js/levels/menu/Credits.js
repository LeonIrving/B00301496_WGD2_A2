class Credits extends Phaser.Scene
{
  ...
  preload()
  {
    this.load.image('credits1',"Survival_Shooter/assets/sprites/credits/credits1.png");
    this.load.image('credits2',"Survival_Shooter/assets/sprites/credits/credits2.png");
    this.load.image('credits3',"Survival_Shooter/assets/sprites/credits/credits3.png");
    this.load.image('credits4',"Survival_Shooter/assets/sprites/credits/credits4.png");
    this.load.image('credits5',"Survival_Shooter/assets/sprites/credits/credits5.png");
    this.load.image('credits6',"Survival_Shooter/assets/sprites/credits/credits6.png");
  }
